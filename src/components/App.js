...
async loadWeb3() {
  if(window.ethereum) {
    ...
    window.alert('Non ethereum browser detected. You shoild consider trying metamask')
  }
}
...
async loadBlockchainData() {
  ...
  if(networkData) {
   ...
   console.log('Direccion Smart Contract', smart_contract)
   } else {
      ...
      <div>
        ...
        <div className="container-fluid mt-5">
          <div className="row">
            ...
            <form onSubmit = {(event) => {
              event.preventDefault()
              const mensaje = 'Incremento de tokens del Smart Contract'
              ...
              <input type = 'submit'
               ...
               value = 'INCREMENTO DE TOKENS (Only by owner)'/>
